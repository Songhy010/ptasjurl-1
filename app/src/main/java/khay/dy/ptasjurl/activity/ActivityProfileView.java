...
public class ActivityProfileView extends ActivityController {
    ...
    private void initProfile() {
        try {
            ...
            final String address_dis = object.getString(Global.arData[49]).equals("null") ? "Phnom Penh" : object.getString(Global.arData[49]);
            ...
            tv_email.setText(email_dis);
            tv_phone.setText(phone_dis);
            tv_address.setText(address_dis);
