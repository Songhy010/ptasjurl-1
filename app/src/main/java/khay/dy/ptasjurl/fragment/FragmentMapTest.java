...
public class FragmentMapTest extends Fragment implements OnMapReadyCallback {
    ...
    private HashMap<Marker,String> hashMarker = new HashMap<>();

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (root_view == null) {
            root_view = LayoutInflater.from(getContext()).inflate(R.layout.fragment_map_test, container, false);
        }
        return root_view;
    }
