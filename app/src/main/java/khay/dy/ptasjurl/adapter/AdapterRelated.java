...
public class AdapterRelated extends RecyclerView.Adapter<AdapterRelated.ItemHolder> {

    private JSONArray array;
    private Context context;

    public AdapterRelated(JSONArray array, Context context) {
        this.array = array;
    ...
    public ItemHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        final View view = LayoutInflater.from(context).inflate(R.layout.item_related, parent, false);
    ...
    public class ItemHolder extends RecyclerView.ViewHolder {
        ...
        public ItemHolder(@NonNull View itemView) {
            ...
            card.getLayoutParams().width = MyFunction.getInstance().getScreenWidth(context) - 170;
